...
describe("patterns", () => {
  ...
  describe("diagonal", () => {
    test("it returns values from a single diagonal if the move is not in the center", () => {
    ...
    test("it returns both diagonals if the move is in the center", () => {
      // TODO
    })
  })
})

describe("special square conditions", () => {
  describe("isSquareInCenter", () => {
    ...
    test("it returns false if the square is not (or cannot be) in the center of the grid", () => {
